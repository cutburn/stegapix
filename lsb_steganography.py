...
def steganographize(veil_image_path, message_image_path):
    ...
    Replace the LSBs of the veil image and with the pixel data of
    the message image, renormalized to the range of values the LSBs
    can represent.
...
def main():
    ...
    handle_args(parser, options, args)
